    ...
    <ThemeProvider theme={theme}>
      ...
      <CacheProvider value={cache}>
        <div className="relative h-screen">
          <header className="fixed left-0 right-0 top-0 z-10 flex items-center justify-between  bg-gray-800 px-4 py-2 text-white">
          ...
          <footer className="absolute bottom-0 left-0 right-0 flex justify-center bg-gray-800 px-2 py-1 text-sm text-white">
