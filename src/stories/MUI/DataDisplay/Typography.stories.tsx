...
export const GutterBottom: Story = {
  render: () => (
    <Box>
      <Typography variant='body1'>gutterBottom なし</Typography>
      <Typography variant='body1'>次の行</Typography>
      <Box sx={{ mt: 3 }} />
      <Typography variant='body1' gutterBottom>
        gutterBottom あり
      </Typography>
      <Typography variant='body1'>次の行（余白がある）</Typography>
    </Box>
  ),
}
...
export const NoWrap: Story = {
  render: () => (
    <Box sx={{ width: 200, border: '1px solid', borderColor: 'divider', p: 1 }}>
      <Typography noWrap>
        この長いテキストは折り返されず、省略記号で表示されます。Lorem ipsum
        dolor sit amet.
      </Typography>
    </Box>
  ),
