...
1. Create a GitHub Personal Access Token with `packages:read` and `packages:write` scopes
...
If you're using GitHub Actions to publish automatically, ensure you have the `GITHUB_TOKEN` secret properly configured in your workflow file.
